...
async def ejercicio(
    ...
    # Voz premium (ElevenLabs) para Ejercicio del momento — es "propio de la
    # herramienta", mismo criterio que ya se usa en Meditación guiada.
    audio_consigna, audio_fundamento, audio_pregunta = await asyncio.gather(
        ...
        texto_a_audio_base64(resultado["fundamento"], voz_premium=True),
        texto_a_audio_base64(pregunta_seguimiento, voz_premium=True),
    )
