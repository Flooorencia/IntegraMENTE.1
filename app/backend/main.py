...
async def ejercicio(
    ...
    # Voz normal (Edge-TTS) en las tres partes: ElevenLabs queda reservado
    # únicamente para Meditación guiada.
...
# visual que la meditación: círculo, puntos, música de fondo — pero con
# voz normal en vez de premium, ya que ElevenLabs queda reservado
# únicamente para Meditación guiada).
# Mismo criterio lazy: solo la intro trae audio ya generado; cada paso
# se pide bajo demanda a /api/tts (voz normal), sin usar el endpoint
# /api/meditacion/audio-paso para no consumir cuota de ElevenLabs.
# -----------------------------------------------------------------
...
async def ejercicio_guiado(
    ...
    # Voz normal (Edge-TTS): ElevenLabs queda reservado únicamente para
    # Meditación guiada, para no gastar cuota en el resto de la app.
...
async def ejercicio_guiado_audio_cierre(
    ...
    # Voz normal (Edge-TTS): igual que la intro de arriba, este cierre no
    # usa ElevenLabs — esa voz queda exclusivamente para Meditación guiada.
