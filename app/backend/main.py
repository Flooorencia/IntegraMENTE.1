...
# importa si el texto es de un ejercicio o una meditación).
# -----------------------------------------------------------------
...
async def ejercicio_guiado_audio_cierre(
    ...
    audio_fundamento = await texto_a_audio_base64(fundamento, voz_premium=True)
    audio_pregunta = await texto_a_audio_base64(pregunta_cierre, voz_premium=True)
    return JSONResponse({
        "audio_fundamento_base64": audio_fundamento,
        "audio_pregunta_seguimiento_base64": audio_pregunta,
    })
